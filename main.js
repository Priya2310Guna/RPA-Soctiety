$(document).ready(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Close the description box when clicking outside
        document.addEventListener('click', function(e) {
          if (!e.target.closest('.event-description')) {
            const openDescriptions = document.querySelectorAll('.event-description.show');
            openDescriptions.forEach(desc => desc.classList.remove('show'));
          }
        });
      });
